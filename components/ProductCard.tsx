...
const ProductCard = ({ product }: Props) => {
  ...
  return (
    <div className="border border-gray-300 rounded-lg overflow-hidden group text-sm mt-10 ">
      <div className="relative border-b border-b-gray-300 overflow-hidden">
        {product?.image && (
        ...
        {product?.stock === 0 && (
          <div className="absolute top-0  left-0  h-full w-full flex items-center justify-center  bg-black bg-opacity-55 ">
      ...
      <div className="p-5 flex flex-col gap-2 ">
        ...
        <p className="text-base text-gray-600 tracking-wide font-extrabold line-clamp-1 capitalize">
          {product?.name}
        </p>
